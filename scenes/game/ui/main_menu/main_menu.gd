...
const PATH_LEVEL_Xtra = "res://scenes/game/levels/rooms/scene_sandbox/sandbox.tscn"
...
func _on_sand_box_button_pressed():
		SceneTransition.change_scene(PATH_LEVEL_Xtra)
		_started = true
